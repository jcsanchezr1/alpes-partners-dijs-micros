#!/usr/bin/env python3
"""
Script para ejecutar el microservicio de contratos.
NOTA: Contratos es completamente asíncrono, solo consume eventos.
...
def health_check():
    ...
    return jsonify({
        'status': 'healthy',
        'service': 'contratos-microservice'
    })
...
def start_consumer():
    ...
    try:
        ...
        suscribirse_a_eventos_campanas_desde_contratos()
